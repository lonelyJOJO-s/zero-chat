...
func (c *userServiceClient) SoftDelUser(ctx context.Context, in *DelUserInfoReq, opts ...grpc.CallOption) (*DelUserInfoResp, error) {
	...
	err := c.cc.Invoke(ctx, UserService_SoftDelUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) SearchUserFuzzy(ctx context.Context, in *SearchUserFuzzyReq, opts ...grpc.CallOption) (*SearchUserFuzzyResp, error) {
	...
	err := c.cc.Invoke(ctx, UserService_SearchUserFuzzy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
const (
	...
	FriendService_UpdateLastTime_FullMethodName    = "/pb.FriendService/updateLastTime"
)
...
func (c *friendServiceClient) AddFriends(ctx context.Context, in *AddFriendsReq, opts ...grpc.CallOption) (*AddFriendsResp, error) {
	...
	err := c.cc.Invoke(ctx, FriendService_AddFriends_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendServiceClient) DelFrineds(ctx context.Context, in *DelFriendsReq, opts ...grpc.CallOption) (*DelFriendsResp, error) {
	...
	err := c.cc.Invoke(ctx, FriendService_DelFrineds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendServiceClient) SearchFriendFuzzy(ctx context.Context, in *SearchFriendFuzzyReq, opts ...grpc.CallOption) (*SearchFriendFuzzyResp, error) {
	...
	err := c.cc.Invoke(ctx, FriendService_SearchFriendFuzzy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendServiceClient) GetUuid(ctx context.Context, in *GetUuidReq, opts ...grpc.CallOption) (*GetUuidResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUuidResp)
	err := c.cc.Invoke(ctx, FriendService_GetUuid_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *friendServiceClient) UpdateLastTime(ctx context.Context, in *UpdateLastTimeReq, opts ...grpc.CallOption) (*UpdateLastTimeResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateLastTimeResp)
	err := c.cc.Invoke(ctx, FriendService_UpdateLastTime_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FriendServiceServer interface {
	...
	UpdateLastTime(context.Context, *UpdateLastTimeReq) (*UpdateLastTimeResp, error)
...
func (UnimplementedFriendServiceServer) UpdateLastTime(context.Context, *UpdateLastTimeReq) (*UpdateLastTimeResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateLastTime not implemented")
}
...
func _FriendService_UpdateLastTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateLastTimeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FriendServiceServer).UpdateLastTime(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FriendService_UpdateLastTime_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FriendServiceServer).UpdateLastTime(ctx, req.(*UpdateLastTimeReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FriendService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "updateLastTime",
			Handler:    _FriendService_UpdateLastTime_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "usercenter.proto",
...
func (c *groupServiceClient) GetMemberIds(ctx context.Context, in *GetMemberIdsReq, opts ...grpc.CallOption) (*GetMemberIdsResp, error) {
	...
	err := c.cc.Invoke(ctx, GroupService_GetMemberIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *groupServiceClient) GetManagedGroupIds(ctx context.Context, in *GetManagedGroupIdsReq, opts ...grpc.CallOption) (*GetManagedGroupIdsResp, error) {
	...
	err := c.cc.Invoke(ctx, GroupService_GetManagedGroupIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *groupServiceClient) GetJoinedGroupIds(ctx context.Context, in *GetJoinedGroupIdsReq, opts ...grpc.CallOption) (*GetJoinedGroupIdsResp, error) {
	...
	err := c.cc.Invoke(ctx, GroupService_GetJoinedGroupIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *groupServiceClient) SearchAllGroup(ctx context.Context, in *SearchAllGroupReq, opts ...grpc.CallOption) (*SearchAllGroupResp, error) {
	...
	err := c.cc.Invoke(ctx, GroupService_SearchAllGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil

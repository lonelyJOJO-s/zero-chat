...
func SearchJoinedGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchJoinedGroupReq
		...
		l := group.NewSearchJoinedGroupLogic(r.Context(), svcCtx)
		resp, err := l.SearchJoinedGroup(&req)
		// uniform return
